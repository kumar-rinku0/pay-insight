  ...
  return (
    <div className="bg-white min-h-screen py-10 px-6 md:px-20 text-gray-800">
      <div className="max-w-4xl mx-auto">
        <div className="text-3xl font-bold mb-6 border-b pb-2 text-blue-700">
          Terms &amp; Conditions
        </div>
        <div className="space-y-5 text-lg leading-relaxed">
          <ol className="list-decimal ml-6 space-y-2 text-gray-700">
            ...
            <li>
              ...
              of domain name https://pay-insight.vercel.app ('Website'),
              including the related mobile site and mobile application
              (hereinafter referred to as 'Platform').
            </li>
            <li>
              The Platform is owned by PAYINSIGHT, a company incorporated under
              the Companies Act, 1956 with its registered office at Jawahar
              Nagar, Jaipur ,Jaipur ,India (hereinafter referred to as ?Platform
              Owner?, 'we', 'us', 'our')..
            </li>
            <li>
