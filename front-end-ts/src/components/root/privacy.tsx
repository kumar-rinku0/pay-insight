  ...
  return (
    <div className="bg-white min-h-screen py-10 px-6 md:px-20 text-gray-800">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 border-b pb-2 text-blue-700">
          Privacy Policy
        </h1>
        <div className="space-y-5 text-lg leading-relaxed">
          <div>
            <strong>Introduction</strong>
            -This Privacy Policy describes how PAYINSIGHT and its affiliates
            (collectively &quot;PAYINSIGHT, we, our, us&quot;) collect, use,
            share, protect or otherwise process your information/ personal data
            through our website https://pay-insight.vercel.app (hereinafter
          ...
          <div>
            ...
            course of our relationship.and related information provided from
            time to time. Some of the information that we may collect includes
            but is not limited to personal data / information provided to us
            during sign-up/registering or using our Platform such as name, date
            of birth, address, telephone/mobile number, email IDand/or any such
            ...
            email, a call from a person/association claiming to be PAYINSIGHT
          ...
          <div>
            ...
            you request. To the extent we use your personal data to market to
            you, we will provide you the ability to opt-out of such uses. We use
            ...
            resolve disputes; troubleshoot problems; inform you about online and
            offline offers, products, services, and updates; customise your
            experience; detect and protect us against error, fraud and other
            criminal activity; enforce our terms and conditions; conduct
            marketing research, analysis and surveys; and as otherwise described
            to you at the time of collection of information. You understand that
            your access to these products/services may be affected in the event
          ...
          <div>
            ...
            the account is deleted, you will lose access to the account. We
          ...
          <div>
            ...
            Platform in accordance with this Privacy Policy. If you disclose to
            us any personal data relating to other people, you represent that
